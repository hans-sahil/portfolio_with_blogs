export const site = {
  ...
  location: "India",
  pitch:
    "Full-stack engineer with 2+ years building scalable web applications — now leveraging AI tooling, Claude Code, and MCP servers to ship smarter, faster products with React, TypeScript, and Node.js.",
  bio: [
    ...
    "At Taghash, I've shipped a fund performance & investment analytics platform end-to-end for Limited Partners — including data visualization dashboards, automated DOCX reporting, and secure RBAC systems backed by Express.js and PostgreSQL.",
    "I use AI tooling daily — Claude Code for agentic coding workflows, MCP servers to connect AI models to real data sources, and the Anthropic API to build intelligent features. I write about what I learn so the next engineer has a shorter path.",
  ],
  avatarUrl: "/sahil.jpg",
  socials: {
  ...
  experience: [
    {
      ...
      bullets: [
        ...
        "Built customizable analytics dashboards with Apache ECharts and Cube.js, including a real-time chart builder with advanced filtering supporting 6+ chart types.",
        "Developed an automated DOCX report generation module using DocxTemplater — reduced manual reporting effort by ~60% with secure LP report-sharing.",
      ],
    },
  ],
} as const;
